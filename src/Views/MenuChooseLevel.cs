...
namespace Ratcycle
{
	public class MenuChooseLevel : View
	{
		...
		{
			_gameObjects.Add (new AtlasObject (ContentHandler.GetTexture ("OrangeBG"), new Vector2 (0), _game, this, Color.White, 1, 1, 1, false));
			_gameObjects.Add (new Text(new Vector2(320, 40), _game, this, Model.Layout.standartFontName, "Selecteer level", Color.Black));
			_gameObjects.Add (new Button(ContentHandler.GetTexture("SquareButton"), new Vector2(305, 200), _game, this, subsLevel));
			_gameObjects.Add (new Text (new Vector2 (395, 200), _game, this, Model.Layout.standartFontName, levelCounter.ToString(), Color.Black));
